...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
         ...
         * Encoder mode.
         *
         * If RUN_USING_ENCODER is false, we do NOT
        ...
        // Only apply PIDF when encoder mode is enabled
        if (RUN_USING_ENCODER &&
                MOTOR_VELO_PID != null &&
        ...
        /*
         * Tracking encoder lists.
         *
         * These are left empty because the robot is using
         * the standard mecanum encoder localizer.
         */
    ...
    public void followTrajectoryAsync(
    ...
    public void update() {
        ...
        // Stop NaN pose from entering Road Runner
        if (!isValidPose(pose)) {
        ...
        // Stop NaN velocity from entering Road Runner
        if (velocity != null &&
                !isValidPose(velocity)) {
        ...
        DriveSignal signal =
                trajectorySequenceRunner.update(
                        pose,
                        velocity
                );
    ...
    public void setPIDFCoefficients(
        ...
        if (!Double.isFinite(voltage) || voltage <= 0) {
            voltage = 12.0;
        }
    ...
    public void setWeightedDrivePower(
            Pose2d drivePower) {

        if (!isValidPose(drivePower)) {
    ...
    public List<Double> getWheelPositions() {
        ...
        for (DcMotorEx motor : motors) {
             ...
             * IMPORTANT:
             *
             * If DriveConstants.TICKS_PER_REV is 0,
             * encoderTicksToInches() creates NaN/Infinity.
             */
    ...
    public void setMotorPowers(
        ...
        /*
         * Never send NaN or Infinity to Webots.
         */
    ...
    public double getRawExternalHeading() {
        // Webots simulator may return NaN for the IMU.
        // Return a safe heading instead of allowing NaN into Road Runner.
        return 0.0;
    }

    @Override
    public Double getExternalHeadingVelocity() {
        // Webots simulator may return null for IMU angular velocity.
        // Return zero so Road Runner never receives a null/NaN value.
        return 0.0;
    }
    ...
    public static TrajectoryAccelerationConstraint
    getAccelerationConstraint(
            double maxAccel) {

        return new ProfileAccelerationConstraint(
                maxAccel
        );
    }
}
